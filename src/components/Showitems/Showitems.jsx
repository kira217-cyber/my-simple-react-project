  ...
  .then(data=>setFoods(data.meals))
    ...
    return (
        <div className='md:container mx-auto mt-10'>
            <h1 className='text-center text-4xl font-bold'>Please Selected One Category</h1>
            ...
            <div className='w-1/4 bg-gray-300 p-4 rounded-xl'>
                ...
                {
                    addToCart.map((cart)=><p className='p-2 bg-amber-100 text-center mt-4 rounded-xl flex justify-between items-center'>{cart.strMeal}<button onClick={()=>handleRemoveToCart(cart.idMeal)} className='items-center justify-center hover:cursor-pointer'><MdCancel size={20}/></button></p>)
                }
